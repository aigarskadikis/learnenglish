...
function appendScrollBar() {
    ...
    lineup.src = "../../images/scrollUp.gif";
    lineup.height = imgH;
    lineup.width = imgW;
    ...
    // scrollWrapper is the scroll bar div //defines "page" region color and 3-D borders
   ...
   // wrapper.style.left = this.ownerWidth + this.ownerBorder - 
    ...
    wrapper.style.borderTop = "1px solid #666666";
    wrapper.style.borderLeft = "1px solid #666666";
    wrapper.style.borderRight= "1px solid #cccccc";
    wrapper.style.borderBottom= "1px solid #cccccc";
   ...
   // wrapper.style.width = lineup.width + (this.quirks.scrollBorder * 2) + "px";
    ...
    linedn.src = "../../images/scrollDn.gif";
    linedn.height = imgH;
    linedn.width = imgW;
    ...
    thumb.src = "../../images/thumb.gif";
    thumb.height = thumbH;
    thumb.width = imgW;
    thumb.alt = "Scroll Dragger";
    thumb.style.position = "absolute";
	//	popAlert(lineup.height)
...
// click event handler - NOT NEEDED as arrow buttons removed
...
function updateScroll() {
   ...
   // popAlert(parseInt(DHTMLAPI.getComputedStyle(scroller.thumb.id, "left")))
...
var dragObject = {
    ...
    dragIt : function (evt) {
       ...
       // next is botch to keep scrollbar in correct place
		x=0;
